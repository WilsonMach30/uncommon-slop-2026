...
# # Map numeric levels to clear text indicators for the prompt
...
#             "You must adapt your vocabulary, sentence structure complexity, and script usage to the user's explicit language proficiency level. "
...
#         prompt = f"""
#         Generate a reading compilation in {target_language} adjusted to a {level_name} level profile.
...
#         # Make sure 'reading_output.txt' exists in your root folder with your dummy evaluation structure.
