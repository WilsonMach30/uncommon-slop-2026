...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dumb Ways to AI — Language RPG" },
      { name: "description", content: "A gamified RPG language learning adventure. Explore regions, complete quests, and grow your streak." },
      { name: "author", content: "Dumb Ways to AI" },
      { property: "og:title", content: "Dumb Ways to AI — Language RPG" },
      { property: "og:description", content: "A gamified RPG language learning adventure. Explore regions, complete quests, and grow your streak." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Noto+Serif:wght@600;700;900&family=JetBrains+Mono:wght@400;500;600&display=swap" },
